...
case $model in
	...
	INSTITUTE=CCCma
        ...
        ENS=r1i1p1f1
        VER=(latest)
        GRID=(gn) # 3.04677271842957, 9.4540491104126, 16.3639659881592
	...
	INSTITUTE=MOHC
        ...
        ENS=r1i1p1f2
        VER=(latest)
        GRID=(gn) # 0.505760014057159, 1.55585527420044, 2.66768169403076
	...
	INSTITUTE=CNRM-CERFACS
        ...
        ENS=r1i1p1f2
        VER=(latest)
        GRID=(gn) # 0.505760017002558, 1.55585530384678, 2.6676817536727,
